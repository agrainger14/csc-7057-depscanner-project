...
import SubmittedSuccess from '../../components/AddProjectForm/SubmittedSuccess';
  ...
  return (
    <Box sx={{ width: '100%'  }}>
      ...
      {activeStep === steps.length ? (
        ...
        <React.Fragment>
          <ProjectForm {...{projectName, projectDescription, projectDependencies, setProjectName, setProjectDescription, setProjectDependencies, activeStep, setEnableNext, setActiveStep, scanFrequency, setScanFrequency, setIsFormValid }}/>
          <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
            {activeStep === 0 ? null : ( 
            <Button
              color="inherit"
            ...
            <Box sx={{ flex: '1 1 auto' }} />
            {activeStep === 0 ? null : (
            <Button onClick={handleNext} disabled={!enableNext || !isFormValid}>
