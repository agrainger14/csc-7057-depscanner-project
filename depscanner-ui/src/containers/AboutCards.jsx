...
import { Hidden, Box, Card, CardContent, Grid, Typography, Container, Stack, CardMedia, Divider } from '@mui/material'
        ...
        <Grid container direction="row" alignItems="stretch" justifyContent="center">
          ...
          <Card sx={{ maxWidth: 300, mt: 4, ml: 4, mb: 4 }}>
            ...
            <CardContent sx={{textAlign: 'center'}}>
              ...
              <Typography variant="body2" color="text.secondary">
              Daily scans are performed to obtain the latest security information.
