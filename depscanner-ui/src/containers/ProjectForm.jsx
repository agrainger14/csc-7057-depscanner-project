...
const ProjectForm = ({projectDependencies, setProjectName, setProjectDescription, setProjectDependencies, activeStep, setEnableNext, setActiveStep, setProjectSubmitted, setIsLoading }) => {
  return (
    <>
      <Paper sx={{mt: 2}}>
        <form>
          ...
          <FormGroup sx={{ display: activeStep === 2 ? '' : 'none', m: 2 }}>
            {activeStep === 2 && <ProjectDetail {...{setProjectName, setProjectDescription}} />}
          </FormGroup>
        </form>
      </Paper>
    </>
